...
#         self.home_path = '/rossmann-store-sales/'
    ...
    def data_preparation(self, df5):
        ...
        ## 5.2 Rescaling
        # competition_distance
        df5['competition_distance'] = self.scaler_competition_distance.fit_transform(df5[['competition_distance']].values)

        # year
        df5['year'] = self.scaler_year.fit_transform(df5[['year']].values)

        # competition_time_month
        df5['competition_time_month'] = self.scaler_competition_time_month.fit_transform(df5[['competition_time_month']].values)

        # promo_time_week
        df5['promo_time_week'] = self.scaler_promo_time_week.fit_transform(df5[['promo_time_week']].values)
        ...
        df5['store_type'] = self.encoder_store_type.fit_transform(df5['store_type'])
